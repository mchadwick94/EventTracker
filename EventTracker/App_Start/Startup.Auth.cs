...
namespace EventTracker
    ...
    public partial class Startup
        ...
        public void ConfigureAuth(IAppBuilder app)
            {
            // Configure the db context, user manager and signin manager to use a single instance
            // per request
            ...
            // third party login provider Configure the sign in cookie
            ...
            // phone or email. Once you check this option, your second step of verification during
            // the login process will be remembered on the device where you logged in from. This is
